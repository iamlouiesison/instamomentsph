...
export const FILIPINO_EVENT_TYPES = {
  ...
  anniversary: { label: 'Anibersaryo', icon: '💕', description: 'Anniversary celebration' },
...
export const SUBSCRIPTION_TIERS = {
  ...
  standard: {
    ...
    storageDays: 14,
    hasVideoAddon: false,
    features: ['100 photos', '14-day storage', 'Email sharing', 'Social media integration', 'Custom themes']
  },
  premium: {
    label: 'Premium',
    price: 1999,
    ...
    storageDays: 30,
    hasVideoAddon: false,
    features: ['250 photos', '30-day storage', 'Advanced moderation', 'Professional layouts', 'Priority support']
  },
  pro: {
    label: 'Pro',
    price: 3499,
    ...
    storageDays: 30,
    hasVideoAddon: false,
    features: ['500 photos', '30-day storage', 'Custom branding', 'Advanced analytics', 'Dedicated support']
  }
} as const
...
export const EventCreateSchema = z.object({
  ...
  description: z.string()
    ...
    .optional(),
  eventType: z.enum(['wedding', 'birthday', 'debut', 'christening', 'graduation', 'anniversary', 'corporate', 'other']),
  eventDate: z.string()
    .optional()
    .refine((date) => {
      if (!date) return true
...
export function generateGallerySlug(eventName: string, eventDate?: string): string {
...
export function calculateEventPrice(tier: keyof typeof SUBSCRIPTION_TIERS, hasVideoAddon: boolean): number {
