...
export default function TestUploadPage() {
  ...
  >('upload');
  const [selectedPhotos, setSelectedPhotos] = useState<ProcessedImage[]>([]);
  ...
  const handlePhotosSelected = (photos: ProcessedImage[]) => {
      ...
      <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Card className="max-w-md mx-auto">
            ...
            <CardContent className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <Badge
                  variant={
                    MOCK_EVENT.requiresModeration ? 'destructive' : 'secondary'
                  }
                >
                  {MOCK_EVENT.requiresModeration ? 'Required' : 'Auto-approve'}
                </Badge>
              </div>
              <div className="flex justify-between">
          ...
          <AlertDescription>
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 text-sm">
                <li>
                  Try uploading different image formats (JPEG, PNG, WebP, HEIC)
                </li>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  ...
                  <div className="text-sm text-green-600">Photos Uploaded</div>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Test camera capture functionality on mobile devices. Should work
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Automatic compression, WebP conversion, and thumbnail generation
